...
<div class="container">
    <form action="${pageContext.request.contextPath}/noticeDelete" method="post" enctype="multipart/form-data">
        공지번호:<input class="form-control" id="inputNoticeNUM" type="text" name="inputNoticeNUM"/>
        공지번호 확인:<input class="form-control" id="inputNoticeNUMConfirm" type="text" name="inputNoticeNUMConfirm"/>
