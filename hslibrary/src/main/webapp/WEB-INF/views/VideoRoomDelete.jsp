...
<div>
    <form action="${pageContext.request.contextPath}/VideoRoomDelete" method="post" enctype="multipart/form-data">
        시청각실 번호:<input class="form-control" id="inputVidRoomNUM" type="text" name="inputVidRoomNUM"/>
        시청각실 번호 확인:<input class="form-control" id="inputVidRoomNUMConfirm" type="text" name="inputVidRoomNUMConfirm"/>
        <input type="submit" value="시청각실 삭제">
    </form>
</div>
