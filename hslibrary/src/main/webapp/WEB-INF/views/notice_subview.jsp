...
%>
<h2>공지번호 ${noticeDTO.noticeNUM}의 공지입니다.</h2>
<p>${noticeDTO.noticeNUM}</p>
<p>${noticeDTO.noticeTitle}</p>
<p>${noticeDTO.noticeDate}</p>
<p>${noticeDTO.noticeAuthor}</p>
<p>${noticeDTO.noticeMain}</p>
